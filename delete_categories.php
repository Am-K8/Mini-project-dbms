...
if(isset($_POST['delete_brand'])) {
    ...
    $delete_query = "DELETE FROM `categories` WHERE category_title = '$brand_title'";
    ...
    echo "<script>alert('No Such Category is present.');</script>";
...
<h2 class="text-center">Delete Categories</h2>
...
<div class="input-group w-99 mb-2">
  ...
  <input type="text" class="form-control" name="brand_title" placeholder="Delete Category" aria-label="Brands" aria-describedby="basic-addon1">
</div>

<div class="input-group w-8 mb-2 m-auto">
  
<input type="submit" class=" bg-secondary border-2 p-2 my-3" name="delete_brand" value="Delete Category" aria-label="Username" aria-describedby="basic-addon1" class=bg-secondary>
