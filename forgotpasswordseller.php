...
function sendMail($email,$reset_token)
{
    ...
    try {
        ...
        <a href = 'http://localhost/project/MODULE1/updatepasswordseller.php?email=$email&reset_token=$reset_token'>Reset Password</a>";
...
if(isset($_POST['send-reset-link']))
{
    ...
    if($result)
    {
        if(mysqli_num_rows($result)==1)
        {
            ...
            $query = "UPDATE `user` SET `resettoken`='$rtoken',`resettokenexpire`='$date' WHERE `email`='$_POST[email]' "  ;
