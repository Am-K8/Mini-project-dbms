...
if(isset($_POST['insert_product'])) {
    $brand_title = $_POST['product_title'];
...
if(isset($_POST['insert_product']))
{
    ...
    else
    {
        ...
        if($result_query)
        {
            echo "<script>alert('Successfully updated products')
...
<body class="bg-light">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <!--price-->
        <div class="form-outline mb-4 w-50 m-auto">
            <input type="submit" name="insert_product" class="btn btn-secondary mb-3 px-3" value="Update Products">
        </div>
    </form>
</body>
</html>